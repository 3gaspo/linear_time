...
LIGHT_NAMES = {
    "timing.json", "alpha_selection.json", "member_split.json", "fit_summary.json",
    "panel_metadata.json", "coefficient_heads.json", "default_manifest.json",
    "user_generalization_manifest.json", "variate_modes_manifest.json",
